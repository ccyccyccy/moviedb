...
API doesn't provide the functionality to search by movie name & category together. Hence I will reset the category bar on search, and reset the search bar on category set.
